...
% Board diagrams are pre-rendered PDFs (built locally with xskak/chessboard from
% the same FENs and included via \includegraphics) rather than drawn live in this
% document, so the manuscript has no chessboard/tikz dependency at compile time.
...
open question in informal play (Pawn Game, n.d.; Lichess Forum, n.d.).
...
\begin{figure}[t]
\centering
\includegraphics{diag-start.pdf}
...
\begin{tabular}{cc}
\includegraphics{diag-grid-n1.pdf} & \includegraphics{diag-grid-n2.pdf} \\
...
\includegraphics{diag-grid-n3.pdf} & \includegraphics{diag-grid-n4.pdf} \\
...
\includegraphics{diag-grid-n5.pdf} & \includegraphics{diag-grid-n6.pdf} \\
...
\includegraphics{diag-grid-n7.pdf} & \includegraphics{diag-grid-n8.pdf} \\
...
\begin{figure}[t]
\centering
\includegraphics{diag-break.pdf}
...
\bibitem[Philidor, 1749]{philidor1749}
Philidor, F.-A.~D. (1749).
\emph{L'Analyze des Échecs}. London.
...
(Vol.~2, pp.~501--504). Cambridge University Press.

\bibitem[Pawn Game, n.d.]{pawngame}
The pawn game: rules and reference implementation. (n.d.).
Retrieved from \url{https://github.com/adanhammod/pawn-game}.

\bibitem[Lichess Forum, n.d.]{lichess}
Pawn game solution. (n.d.). Lichess Forum, General Chess Discussion.
Retrieved from
\url{https://lichess.org/forum/general-chess-discussion/pawn-game-solution}.

\bibitem[Fiekas et al., n.d.]{pythonchess}
Fiekas, N., \& contributors. (n.d.).
\emph{python-chess}: a chess library for Python.
Retrieved from \url{https://python-chess.readthedocs.io}.

\bibitem[Stockfish Developers, n.d.]{stockfish}
Stockfish Developers. (n.d.).
\emph{Stockfish}: a strong open-source chess engine.
Retrieved from \url{https://stockfishchess.org}.

\bibitem[Livne, 2026]{reprorepo}
Livne, O. (2026).
Pawn game solver: source code, tests, engine API, and result data for this paper.
Retrieved from \url{https://github.com/orenlivne/pawngame}.
