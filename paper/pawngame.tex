...
\begin{enumerate}
  ...
  Stockfish for each $n$ and rule, all run on the same \texttt{n2-highmem-32} used
  for the solves. From a winning side the tablebase wins all 100 and from a drawing
  side it never loses; the loss column is zero in every row.
\end{enumerate}
